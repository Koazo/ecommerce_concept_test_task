  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PhonesListCubit, PhonesState>(
      builder: (context, state) {
        PhoneEntity phones = PhoneEntity(homeStore: [], bestSeller: []);
        ...
        return PageView.builder(
          itemCount: phones.bestSeller.length + phones.homeStore.length,
          pageSnapping: true,
            ...
            return Stack(
              children: [
                ...
                pagePosition != 1
                    ...
                    : Padding(
                        padding:
                            const EdgeInsets.only(top: 10, left: 35, bottom: 5),
                        child: Column(
